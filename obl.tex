...
\begin{center}
  \includegraphics[width=0.6\textwidth]{opg13_1.pdf}
\end{center}
...
\begin{center}
  \includegraphics[width=0.6\textwidth]{opg13_2.pdf}
\end{center}
...
\begin{center}
  \includegraphics[width=0.6\textwidth]{opg16.pdf}
\end{center}
...
\begin{flalign*}
  P(X + Y =< 1) &= \int_0^{1/2} \left( \int_x^{1 - x} \frac{4x^3}{y^3} \mathrm{d}y \right) \mathrm{d}x &\\
...
\begin{flalign*}
  E(X) &= \int_0^1 xf_X(x)\mathrm{d}x = \int_0^1 2x^2 \mathrm{d}x = \left[ \frac{2}{3}x^3 \right]_0^1 &\\
  &= \frac{2}{3} &\\
  E(X^2) &= \int_0^1 x^2 f_X(x)\mathrm{d}x = \int_0^1 2x^3 \mathrm{d}x = \left[ \frac{1}{2}x^4 \right]_0^1 &\\
  &= \frac{1}{2} &\\
  Var(X) &= E(X^2) - (E(X))^2 = \frac{1}{2} - \frac{4}{9} &\\
  &= \frac{1}{18} &\\
\end{flalign*}
...
\begin{flalign*}
  E(Y) &= \int_0^1 yy \mathrm{d}y + \int_1^\infty yy^{-3} \mathrm{d}y &\\
  &= \frac{4}{3} &\\
\end{flalign*}
...
\begin{flalign*}
  ...
  &= \frac{1}{4} + \int_1^\infty y^{-1} \mathrm{d}y &\\
  &= \infty &\\
\end{flalign*}
